...
3. The structure is added beside the current one without overlapping (bounding-sphere separation); repeat the import to stack further copies. Each import is one **Undo** step, and **Save As** exports everything together
