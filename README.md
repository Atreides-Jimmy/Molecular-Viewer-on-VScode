...
4. Every copy is added beside the existing structure without overlapping it (bounding-sphere separation), so copies stack along +X and never overlap each other; each copy is one **Undo** step and **Save As** exports everything together
